/* This is the (CORRECT) sticky version.
Please keep this window size to at least 100w x 35h as well.

This is also the sexy version. It just looks nice in lxterm with a 
translucent background. Used this style for final demonstration of 
animated BD.

Also, variance values are incorrect. Durrf.   */

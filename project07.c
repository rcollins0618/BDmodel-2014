/* This is the sticky version. 
Please keep this window size to at least 100w x 35h as well.

NOTE: This also has incorrect variance values. Assume this for the rest.

ALSO, this is the "incorrect" sticky version where joints are at 45 deg
angles (instead of 90 deg angles).    */
